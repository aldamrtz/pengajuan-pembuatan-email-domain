...
<head>
    ...
    <style>
        ...
        .table th:nth-child(4), .table td:nth-child(4) { 
            width: 15%; /* Nama Penanggung Jawab */
        }
        .table th:nth-child(5), .table td:nth-child(5) { 
            width: 15%; /* Email Penanggung Jawab */
        }
        .table th:nth-child(6), .table td:nth-child(6) { 
            width: 10%; /* Kontak Penanggung Jawab */
        }
        .table th:nth-child(7), .table td:nth-child(7) { 
            width: 10%; /* Sub Domain yang Diajukan */
        }
                ...
                <div class="container-fluid" style="padding-left: 20px; padding-right: 20px;">
                    ...
                    <ul class="nav nav-tabs" id="emailTabs" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="diajukan-tab" data-bs-toggle="tab" data-bs-target="#diajukan" type="button" role="tab" aria-controls="diajukan" aria-selected="true">Sub Domain Diajukan</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="diproses-tab" data-bs-toggle="tab" data-bs-target="#diproses" type="button" role="tab" aria-controls="diproses" aria-selected="false">Sub Domain Diproses</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="diverifikasi-tab" data-bs-toggle="tab" data-bs-target="#diverifikasi" type="button" role="tab" aria-controls="diverifikasi" aria-selected="false">Sub Domain Diverifikasi</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="dikirim-tab" data-bs-toggle="tab" data-bs-target="#dikirim" type="button" role="tab" aria-controls="dikirim" aria-selected="false">Sub Domain Dikirim</button>
                        </li>
                    </ul>
                    <div class="tab-content" id="subdomainTabsContent">
                        <div class="tab-pane fade show active" id="diajukan" role="tabpanel" aria-labelledby="diajukan-tab">
                            <table class="table table-bordered mt-3">
                                ...
                                <tbody>
                                    <?php $no = 1; foreach ($domain_diajukan as $domain): ?>
                                    <tr>
                                        <td><?= $no++; ?></td>
                                        <td><?= $domain['unit_kerja']; ?></td>
                                        <td><?= $domain['nomor_induk']; ?></td>
                                        <td><?= $domain['penanggung_jawab']; ?></td>
                                        <td><?= $domain['email_penanggung_jawab']; ?></td>
                                        <td><?= $domain['kontak_penanggung_jawab']; ?></td>
                                        <td><?= $domain['sub_domain']; ?></td>
                                        <td><?= $domain['ip_pointing']; ?></td>
                        ...
                        <div class="tab-pane fade" id="diproses" role="tabpanel" aria-labelledby="diproses-tab">
                            <table class="table table-bordered mt-3">
                                ...
                                <tbody>
                                    <?php $no = 1; foreach ($domain_diproses as $domain): ?>
                                    <tr>
                                        <td><?= $no++; ?></td>
                                        <td><?= $domain['unit_kerja']; ?></td>
                                        <td><?= $domain['nomor_induk']; ?></td>
                        ...
                        <div class="tab-pane fade" id="diverifikasi" role="tabpanel" aria-labelledby="diverifikasi-tab">
                            <table class="table table-bordered mt-3">
                                ...
                                <tbody>
                                    <?php $no = 1; foreach ($domain_diverifikasi as $domain): ?>
                                    <tr>
                                        <td><?= $no++; ?></td>
                                        <td><?= $domain['unit_kerja']; ?></td>
                                        <td><?= $domain['nomor_induk']; ?></td>
                        ...
                        <div class="tab-pane fade" id="dikirim" role="tabpanel" aria-labelledby="dikirim-tab">
                            <table class="table table-bordered mt-3">
                                ...
                                <tbody>
                                    <?php $no = 1; foreach ($domain_dikirim as $domain): ?>
                                    <tr>
                                        <td><?= $no++; ?></td>
                                        <td><?= $domain['unit_kerja']; ?></td>
                                        <td><?= $domain['nomor_induk']; ?></td>
